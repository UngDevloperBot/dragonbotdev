...
module.exports.run = async (bot, message, args) => {
 ...
 if(tomute.hasPermission("MANAGE_MESSAGES")) return message.reply(`Can\'t tempmute this user beacuse ${tomute} has permission **manage message**!`);
...
let mutelogschannel = message.guild.channels.find(`name`, "mods-log");
if(!mutelogschannel) return message.reply("Pls create **mods-log** channel first!");
